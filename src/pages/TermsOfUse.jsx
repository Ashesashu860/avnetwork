...
export const TermsOfUse = () => {
  return (
    <StyledDiv>
      ...
      <p>
        The avnetwork.in website located at www.avnetwork.in is a copyrighted
        work belonging to AVnetwork. Certain features of the Site may be subject
      ...
      <p>
        ...
        Ads.  Company provides access to these Third-Party Links & Ads only as a
      ...
      <p>
        ...
        the Company should be sent to: India. After the Notice is received, you
        ...
        party may not be disclosed to the arbitrator until after the arbitrator
        has determined the amount of the award to which either party is
        entitled.
      </p>
      ...
      <p>
        ...
        the authority to grant motions dispositive of all or part of any claim. 
        The arbitrator shall have the authority to award monetary damages, and
        to grant any non-monetary remedy or relief available to an individual
        under applicable law, the AAA Rules, and the Terms.  The arbitrator
      ...
      <p>
        ...
        A request for interim measures shall not be deemed a waiver of any other
